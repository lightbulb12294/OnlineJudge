...
//APPEND END""",
    "compile": {
        ...
        "max_real_time": 20000,
        "max_memory": 1024 * 1024 * 1024,
        "compile_command": "/usr/bin/g++-11 -DONLINE_JUDGE -O2 -w -fmax-errors=3 -std=c++20 {src_path} -lm -o {exe_path}",
    },
    "run": {
        "command": "{exe_path}",
        "seccomp_rule": {ProblemIOMode.standard: "c_cpp", ProblemIOMode.file: "c_cpp_file_io"},
...
languages = [
    ...
    {"config": _cpp20_lang_config, "name": "C++20", "description": "G++ 11.4", "content_type": "text/x-c++src"},
