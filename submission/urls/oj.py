...
from ..views.oj import SubmissionAPI, SubmissionListAPI, ContestSubmissionListAPI, SubmissionExistsAPI, SampleTestAPI
...
urlpatterns = [
    ...
    url(r"^sample_test/?$", SampleTestAPI.as_view(), name="sample_test_api")
]
